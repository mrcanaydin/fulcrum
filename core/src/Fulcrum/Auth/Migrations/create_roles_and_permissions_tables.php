...
return new class implements Migration {
    public function up(ConnectionInterface $db): void
    {
        if ($db instanceof PostgresDriver) {
            ...
            $db->statement('CREATE INDEX IF NOT EXISTS model_roles_model_index ON model_roles (model_type, model_id)');
            ...
            $db->statement('CREATE INDEX IF NOT EXISTS model_permissions_model_index ON model_permissions (model_type, model_id)');
