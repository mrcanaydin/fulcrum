...
return new class implements Migration {
    public function up(ConnectionInterface $db): void
    {
        if ($db instanceof PostgresDriver) {
            ...
            $db->statement('CREATE INDEX IF NOT EXISTS users_email_verification_token_index ON users (email_verification_token)');
            $db->statement('CREATE INDEX IF NOT EXISTS users_banned_at_index ON users (banned_at)');
